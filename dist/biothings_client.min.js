...
c(a,function(a){b.ids=a.join(",");return f.request_post(g,b)},function(a){return a})},get_fields:function(a,b){b=b||{};var c=e.url+e.metadata_fields_endpoint;a&&(b.search=a);return f.request_get(c,b)},query:function(a,c,g){g=g||"GET";var h={q:a};b(h,c);var l=e.url+e.query_endpoint;h.fields instanceof Array&&(h.fields=h.fields.join(","));var k="GET"==g?f.request_get:f.request_post;return h.fetch_all?k(l,h,!1).then(function(a){var b=a.total,c=a.hits;h.scroll_id=a._scroll_id;a=Promise.resolve(a);for(var f=
e.step;f<b;f+=e.step)a=a.then(function(a){return k(l,h,!1).then(function(a){c=c.concat(a.hits);return a})});return a.then(function(){return c})}):k(l,h,!1)},query_many:function(a,b){"string"==typeof a&&(a=a.split(","));return c(a,function(a){return f.query(a.join(","),b,"POST")},function(a){return a})},request_get:function(a,b,c){b=b||{};c=c||!1;a={url:a,method:"get",params:b};c&&(a.validateStatus=function(a){return 200<=a&&300>a||404==a});return m.request(a).then(function(a){return c&&404==a.status?
null:a.data})},request_post:function(a,b){b=b||{};return m.request({url:a,method:"post",params:b,headers:{"content-type":"application/x-www-form-urlencoded"}}).then(function(a){return a.data})}};f["get"+a]=f.get_annotation;f["get"+a+"s"]=f.get_annotations;return f}var m=k=c("axios"),a=c("./client_configs.json"),b=c("extend");k.defaults.headers["user-agent"]="biothings_client Node.JS package";common_args={query_endpoint:"/query/",metadata_endpoint:"/metadata",metadata_fields_endpoint:"/metadata/fields",
top_level_jsonld_uris:[],delay:1,step:1E3,scroll_size:1E3,max_query:1E3};h.exports={get_client:function(c,e){e=e||{};c=c.toLowerCase();if(!a[c]&&!e.url)return null;client_settings={};b(client_settings,common_args,a[c]);client_settings.default_step=client_settings.step;return f(c,client_settings)}}},{"./client_configs.json":2,axios:"axios",extend:"extend"}],2:[function(c,h,k){h.exports={gene:{url:"http://mygene.info/v3",pkg_user_agent_header:"MyGene.py",annotation_endpoint:"/gene/",optionally_plural_object_type:"gene(s)",
default_cache_file:"mygene_cache",entity:"gene"},variant:{url:"http://myvariant.info/v1",pkg_user_agent_header:"MyVariant.py",annotation_endpoint:"/variant/",optionally_plural_object_type:"variant(s)",default_cache_file:"myvariant_cache",entity:"variant",top_level_jsonld_uris:"http://schema.myvariant.info/datasource/cadd http://schema.myvariant.info/datasource/clinvar http://schema.myvariant.info/datasource/dbnsfp http://schema.myvariant.info/datasource/dbsnp http://schema.myvariant.info/datasource/docm http://schema.myvariant.info/datasource/emv http://schema.myvariant.info/datasource/evs http://schema.myvariant.info/datasource/gwassnps http://schema.myvariant.info/datasource/mutdb http://schema.myvariant.info/datasource/snpeff".split(" ")},
